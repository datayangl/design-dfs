...
public class RequestWrapper {
    ...
    public NettyPacket getNettyPacket() {
        return nettyPacket;
    }
    ...
    public void sendResponse(MessageLite response) {
        ...
        NettyPacket nettyResponse = NettyPacket.buildPacket(body, PacketType.getEnum(nettyPacket.getPacketType()));
...
//        }
        sendResponse(nettyResponse, nettyPacket.getSequence());
    }
